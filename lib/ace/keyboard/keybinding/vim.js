...
var vimStates = {
    ...
    onStateChange: function(env, args, request) {
        console.log('onStateChange', env, args, request);
        env.editor.session.setBlockCursor(args.state === 'start');
    }
};
