...
(function() {
    ...
    this.update = function(config) {
        ...
        var overwrite = this.session.getOverwrite(),
            blockCursor = this.session.getBlockCursor();
        ...
        } else if (blockCursor != this.blockCursor) {
            this.blockCursor = blockCursor;
            if (blockCursor)
                dom.addCssClass(this.cursor, "ace_block_cursor");
            else
                dom.removeCssClass(this.cursor, "ace_block_cursor");
        }
